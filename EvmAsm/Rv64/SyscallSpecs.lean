...
@[spec_gen_rv64] theorem ld_spec_gen (rd rs1 : Reg) (v_addr vOld mem_val : Word)
  ...
  generic_ld_spec rd rs1 v_addr vOld mem_val offset addr hrd_ne_x0
...
@[spec_gen_rv64] theorem lbu_spec_gen (rd rs1 : Reg) (v_addr vOld : Word)
    ...
    cpsTriple addr (addr + 4)
      ...
      ((rs1 ↦ᵣ v_addr) ** (rd ↦ᵣ vOld) ** (dwordAddr ↦ₘ word_val))
      ((rs1 ↦ᵣ v_addr) **
       (rd ↦ᵣ (extractByte word_val (byteOffset (v_addr + signExtend12 offset))).zeroExtend 64) **
       (dwordAddr ↦ₘ word_val)) :=
  generic_lbu_spec rd rs1 v_addr vOld offset addr dwordAddr word_val
...
@[spec_gen_rv64] theorem lb_spec_gen (rd rs1 : Reg) (v_addr vOld : Word)
    ...
    cpsTriple addr (addr + 4)
      ...
      ((rs1 ↦ᵣ v_addr) **
       ...
       (dwordAddr ↦ₘ word_val)) :=
  generic_lb_spec rd rs1 v_addr vOld offset addr dwordAddr word_val
    hrd_ne_x0 halign hvalid
...
@[spec_gen_rv64] theorem lhu_spec_gen (rd rs1 : Reg) (v_addr vOld : Word)
    ...
    cpsTriple addr (addr + 4)
      ...
      ((rs1 ↦ᵣ v_addr) **
       ...
       (dwordAddr ↦ₘ word_val)) :=
  generic_lhu_spec rd rs1 v_addr vOld offset addr dwordAddr word_val
    hrd_ne_x0 halign hvalid
...
@[spec_gen_rv64] theorem lh_spec_gen (rd rs1 : Reg) (v_addr vOld : Word)
    ...
    cpsTriple addr (addr + 4)
      ...
      ((rs1 ↦ᵣ v_addr) **
       ...
       (dwordAddr ↦ₘ word_val)) :=
  generic_lh_spec rd rs1 v_addr vOld offset addr dwordAddr word_val
    hrd_ne_x0 halign hvalid
...
@[spec_gen_rv64] theorem lwu_spec_gen (rd rs1 : Reg) (v_addr vOld : Word)
    ...
    cpsTriple addr (addr + 4)
      ...
      ((rs1 ↦ᵣ v_addr) **
       ...
       (dwordAddr ↦ₘ word_val)) :=
  generic_lwu_spec rd rs1 v_addr vOld offset addr dwordAddr word_val
    hrd_ne_x0 halign hvalid
...
@[spec_gen_rv64] theorem lw_spec_gen (rd rs1 : Reg) (v_addr vOld : Word)
    ...
    cpsTriple addr (addr + 4)
      ...
      ((rs1 ↦ᵣ v_addr) **
       ...
       (dwordAddr ↦ₘ word_val)) :=
  generic_lw_spec rd rs1 v_addr vOld offset addr dwordAddr word_val
    hrd_ne_x0 halign hvalid
