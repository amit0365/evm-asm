...
theorem divK_loop_body_n4_max_unified_spec
    ...
    (hborrow : if borrow_zero
               then (if BitVec.ult uTop
                     ...
                     then (1 : Word) else 0) ≠ (0 : Word)) :
    cpsBranch (base + loopBodyOff) (sharedDivModCode base)
      (loopBodyPre (4 : Word) sp j jOld v5Old v6Old v7Old v10Old v11Old v2Old
        v0 v1 v2 v3 u0 u1 u2 u3 uTop qOld)
      (base + loopBodyOff)
      (loopBodyUnifiedPostN4 borrow_zero sp j (signExtend12 4095 : Word) v0 v1 v2 v3 u0 u1 u2 u3 uTop)
      (base + denormOff)
      (loopBodyUnifiedPostN4 borrow_zero sp j (signExtend12 4095 : Word) v0 v1 v2 v3 u0 u1 u2 u3 uTop) := by
  cases borrow_zero
...
theorem divK_loop_body_n4_call_unified_spec
    ...
    (hbltu : BitVec.ult uTop v3)
    (hcarry : ¬borrow_zero →
      let ms := mulsubN4 (div128Quot uTop u3 v3) v0 v1 v2 v3 u0 u1 u2 u3
      let ab := addbackN4 ms.1 ms.2.1 ms.2.2.1 ms.2.2.2.1 (uTop - ms.2.2.2.2) v0 v1 v2 v3
      addbackN4_carry ms.1 ms.2.1 ms.2.2.1 ms.2.2.2.1 v0 v1 v2 v3 = 0 →
      addbackN4_carry ab.1 ab.2.1 ab.2.2.1 ab.2.2.2.1 v0 v1 v2 v3 ≠ 0)
    (hborrow : if borrow_zero
               then (if BitVec.ult uTop
                     ...
                     then (1 : Word) else 0) ≠ (0 : Word)) :
    cpsBranch (base + loopBodyOff) (sharedDivModCode base)
      (loopBodyPreWithScratch (4 : Word) sp j jOld v5Old v6Old v7Old v10Old v11Old v2Old
        v0 v1 v2 v3 u0 u1 u2 u3 uTop qOld
        retMem dMem dloMem scratch_un0)
      (base + loopBodyOff)
      (loopBodyUnifiedPostN4 borrow_zero sp j (div128Quot uTop u3 v3) v0 v1 v2 v3 u0 u1 u2 u3 uTop **
       (sp + signExtend12 3968 ↦ₘ (base + 516)) **
       (sp + signExtend12 3960 ↦ₘ v3) **
