...
theorem divK_loop_body_n4_max_unified_spec
    (borrow_zero : Bool)
    (sp j j_old v5_old v6_old v7_old v10_old v11_old v2_old
     v0 v1 v2 v3 u0 u1 u2 u3 u_top q_old : Word)
    (base : Word)
    ...
    (hborrow : if borrow_zero
               then (if BitVec.ult u_top
                     ...
                     then (1 : Word) else 0) ≠ (0 : Word)) :
    cpsBranch (base + loopBodyOff) (sharedDivModCode base)
      (loopBodyPre (4 : Word) sp j j_old v5_old v6_old v7_old v10_old v11_old v2_old
        v0 v1 v2 v3 u0 u1 u2 u3 u_top q_old)
      (base + loopBodyOff)
      (loopBodyUnifiedPostN4 borrow_zero sp j (signExtend12 4095 : Word) v0 v1 v2 v3 u0 u1 u2 u3 u_top)
      (base + denormOff)
      (loopBodyUnifiedPostN4 borrow_zero sp j (signExtend12 4095 : Word) v0 v1 v2 v3 u0 u1 u2 u3 u_top) := by
  cases borrow_zero
...
theorem divK_loop_body_n4_call_unified_spec
    ...
    (hbltu : BitVec.ult u_top v3)
    (hcarry : ¬borrow_zero →
      let ms := mulsubN4 (div128Quot u_top u3 v3) v0 v1 v2 v3 u0 u1 u2 u3
      let ab := addbackN4 ms.1 ms.2.1 ms.2.2.1 ms.2.2.2.1 (u_top - ms.2.2.2.2) v0 v1 v2 v3
      addbackN4_carry ms.1 ms.2.1 ms.2.2.1 ms.2.2.2.1 v0 v1 v2 v3 = 0 →
      addbackN4_carry ab.1 ab.2.1 ab.2.2.1 ab.2.2.2.1 v0 v1 v2 v3 ≠ 0)
    (hborrow : if borrow_zero
               then (if BitVec.ult u_top
                        (mulsubN4_c3 (div128Quot u_top u3 v3) v0 v1 v2 v3 u0 u1 u2 u3)
                     then (1 : Word) else 0) = (0 : Word)
               else (if BitVec.ult u_top
                        (mulsubN4_c3 (div128Quot u_top u3 v3) v0 v1 v2 v3 u0 u1 u2 u3)
                     then (1 : Word) else 0) ≠ (0 : Word)) :
    cpsBranch (base + loopBodyOff) (sharedDivModCode base)
      (loopBodyPreWithScratch (4 : Word) sp j j_old v5_old v6_old v7_old v10_old v11_old v2_old
        v0 v1 v2 v3 u0 u1 u2 u3 u_top q_old
        ret_mem d_mem dlo_mem scratch_un0)
      (base + loopBodyOff)
      (loopBodyUnifiedPostN4 borrow_zero sp j (div128Quot u_top u3 v3) v0 v1 v2 v3 u0 u1 u2 u3 u_top **
       (sp + signExtend12 3968 ↦ₘ (base + 516)) **
       (sp + signExtend12 3960 ↦ₘ v3) **
       (sp + signExtend12 3952 ↦ₘ div128DLo v3) **
