...
/-- j=3 un3 at u_base(3)+4072 = j=2 uTop at u_base(2)+4064 -/
...
/-- j=2 un3 at u_base(2)+4072 = j=1 uTop at u_base(1)+4064 -/
...
/-- j=1 un3 at u_base(1)+4072 = j=0 uTop at u_base(0)+4064 -/
