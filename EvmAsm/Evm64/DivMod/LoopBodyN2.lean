...
theorem divK_loop_body_n2_max_unified_spec
    ...
    (hborrow : if borrow_zero
               then (if BitVec.ult u_top
                     ...
                     then (1 : Word) else 0) ≠ (0 : Word)) :
    cpsBranch (base + loopBodyOff) (sharedDivModCode base)
      (loopBodyPre (2 : Word) sp j j_old v5_old v6_old v7_old v10_old v11_old v2_old
        v0 v1 v2 v3 u0 u1 u2 u3 u_top q_old)
      (base + loopBodyOff)
      (loopBodyUnifiedPostN2 borrow_zero sp j (signExtend12 4095 : Word) v0 v1 v2 v3 u0 u1 u2 u3 u_top)
      (base + denormOff)
      (loopBodyUnifiedPostN2 borrow_zero sp j (signExtend12 4095 : Word) v0 v1 v2 v3 u0 u1 u2 u3 u_top) := by
  cases borrow_zero
...
theorem divK_loop_body_n2_call_unified_spec
    ...
    (hborrow : if borrow_zero
               then (if BitVec.ult u_top
                     ...
                     then (1 : Word) else 0) ≠ (0 : Word)) :
    cpsBranch (base + loopBodyOff) (sharedDivModCode base)
      (loopBodyPreWithScratch (2 : Word) sp j j_old v5_old v6_old v7_old v10_old v11_old v2_old
        v0 v1 v2 v3 u0 u1 u2 u3 u_top q_old
        ret_mem d_mem dlo_mem scratch_un0)
      (base + loopBodyOff)
      (loopBodyUnifiedPostN2 borrow_zero sp j (div128Quot u2 u1 v1) v0 v1 v2 v3 u0 u1 u2 u3 u_top **
       (sp + signExtend12 3968 ↦ₘ (base + 516)) **
       (sp + signExtend12 3960 ↦ₘ v1) **
