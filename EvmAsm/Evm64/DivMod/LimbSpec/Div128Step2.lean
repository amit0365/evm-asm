...
theorem divK_div128_step2_spec
    (sp un21 d_hi v1Old v5Old v11Old dlo un0 : Word) (base : Word) :
    ...
    cpsTriple base (base + 60) cr
      ((.x7 ↦ᵣ un21) ** (.x6 ↦ᵣ d_hi) ** (.x5 ↦ᵣ v5Old) **
  ...
  have h1_raw := divK_div128_step2_init_spec un21 d_hi v1Old v5Old v11Old base
