...
theorem divK_mulsub_partA_spec (sp qHat carry_in v5Old v7Old v_i : Word)
...
theorem divK_mulsub_partB_spec (u_base partialCarry prodHi fullSub v2Old u_i : Word)
  ...
  have I0 := ld_spec_gen .x2 .x6 u_base v2Old u_i u_off base (by nofun)
