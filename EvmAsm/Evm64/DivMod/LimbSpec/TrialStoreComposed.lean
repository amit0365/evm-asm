...
theorem divK_trial_load_spec
    (sp j n v5Old v6Old v7Old v10Old u_hi u_lo v_top : Word)
    (base : Word) :
  ...
  have I7 := ld_spec_gen .x6 .x12 sp v6Old n 3984 (base + 28) (by nofun)
  ...
  have I11 := ld_spec_gen .x10 .x6 vtopBase v10Old v_top 32 (base + 44) (by nofun)
  runBlock I0 I1 I2 I3 I4 I5 I6 I7 I8 I9 I10 I11

/-- Store q[j]: compute address and store q_hat. 4 instructions.
    qAddr = sp + 4088 - j*8. -/
theorem divK_store_qj_spec (sp j q_hat v5Old v7Old qOld : Word)
    (base : Word) :
  ...
  have I3 := sd_spec_gen .x7 .x11 qAddr q_hat qOld 0 (base + 12)
  rw [haddr] at I3
