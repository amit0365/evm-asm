...
theorem divK_div128_step1_spec
    (sp u_hi dHi un1 v1Old v5Old v10Old dlo : Word) (base : Word) :
    ...
    cpsTriple base (base + 60) cr
      ((.x7 ↦ᵣ u_hi) ** (.x6 ↦ᵣ dHi) ** (.x10 ↦ᵣ v10Old) **
  ...
  have h1_raw := divK_div128_step1_init_spec u_hi dHi v5Old v10Old base
