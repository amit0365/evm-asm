...
theorem divK_trial_load_u_spec (sp j n v5Old v7Old u_hi u_lo : Word)
    (base : Word) :
    let jpn := j + n
...
theorem divK_trial_load_vtop_spec (sp n v6Old v10Old v_top : Word)
    (base : Word) :
  ...
  have I4 := ld_spec_gen .x10 .x6 vtopBase v10Old v_top 32 (base + 16) (by nofun)
