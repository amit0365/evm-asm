...
theorem divK_loop_body_n2_max_skip_j0_spec
  ...
  have MCS := divK_mulsub_correction_skip_spec sp q_hat (0 : Word) v0 v1 v2 v3 u0 u1 u2 u3 u_top
    (0 : Word) u1 vtop_base u2 v1 v2Old base

  intro_lets at MCS
  have MCS0 := MCS hborrow
  -- 3. Store + loop exit j=0 (cpsTriple base+880 → base+904)
  have SL := divK_store_loop_j0_spec sp q_hat u4_new (0 : Word) qOld base
  intro_lets at SL
...
theorem divK_loop_body_n2_max_skip_j1_spec
  ...
  have MCS := divK_mulsub_correction_skip_spec sp q_hat (1 : Word) v0 v1 v2 v3 u0 u1 u2 u3 u_top
    (1 : Word) u1 vtop_base u2 v1 v2Old base

  intro_lets at MCS
  have MCS0 := MCS hborrow
  have hj_pos := slt_jpos_1
  have SL := divK_store_loop_jgt0_spec sp (1 : Word) q_hat u4_new (0 : Word) qOld base hj_pos
  intro_lets at SL
  have TFf := cpsTriple_frameR
    ((.x2 ↦ᵣ v2Old) **
     ((sp + signExtend12 32) ↦ₘ v0) ** ((u_base + signExtend12 0) ↦ₘ u0) **
...
theorem divK_loop_body_n2_max_skip_j2_spec
  ...
  have MCS := divK_mulsub_correction_skip_spec sp q_hat (2 : Word) v0 v1 v2 v3 u0 u1 u2 u3 u_top
    (2 : Word) u1 vtop_base u2 v1 v2Old base

  intro_lets at MCS
  have MCS0 := MCS hborrow
  have hj_pos := slt_jpos_2
  have SL := divK_store_loop_jgt0_spec sp (2 : Word) q_hat u4_new (0 : Word) qOld base hj_pos
  intro_lets at SL
  have TFf := cpsTriple_frameR
    ((.x2 ↦ᵣ v2Old) **
     ((sp + signExtend12 32) ↦ₘ v0) ** ((u_base + signExtend12 0) ↦ₘ u0) **
...
-- divK_mulsub_correction_addback_beq_spec which handles both carry branches.
-- ============================================================================
...
theorem divK_loop_body_n2_max_addback_j0_beq_spec
  ...
  have SL := divK_store_loop_j0_spec sp q_out u4_out carry_out qOld base
  intro_lets at SL
  have TFf := cpsTriple_frameR
    ((.x2 ↦ᵣ v2Old) **
     ((sp + signExtend12 32) ↦ₘ v0) ** ((u_base + signExtend12 0) ↦ₘ u0) **
...
theorem divK_loop_body_n2_max_addback_j1_beq_spec
  ...
  have MCA0 := MCA hcarry2_nz hborrow
  have hj_pos := slt_jpos_1
  have SL := divK_store_loop_jgt0_spec sp (1 : Word) q_out u4_out carry_out qOld base hj_pos
  intro_lets at SL
  have TFf := cpsTriple_frameR
    ((.x2 ↦ᵣ v2Old) **
     ((sp + signExtend12 32) ↦ₘ v0) ** ((u_base + signExtend12 0) ↦ₘ u0) **
...
theorem divK_loop_body_n2_max_addback_j2_beq_spec
  ...
  have MCA0 := MCA hcarry2_nz hborrow
  have hj_pos := slt_jpos_2
  have SL := divK_store_loop_jgt0_spec sp (2 : Word) q_out u4_out carry_out qOld base hj_pos
  intro_lets at SL
  have TFf := cpsTriple_frameR
    ((.x2 ↦ᵣ v2Old) **
     ((sp + signExtend12 32) ↦ₘ v0) ** ((u_base + signExtend12 0) ↦ₘ u0) **
