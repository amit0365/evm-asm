/-
  EvmAsm.Evm64.DivMod.Compose.DivN1FullShift0
...
theorem evm_div_n1_shift0_preloop_loopbody_spec (sp base : Word)
  ...
  have hPL := evm_div_n1_shift0_to_loopSetup_spec sp base a0 a1 a2 a3 b0 b1 b2 b3 v5 v6 v7 v10
  ...
  · -- Loop-back case: j=3 looped back to base+448, now execute j=2 then j=1 then j=0
    ...
    -- u window at j=2: u0 at SE12(4040)=a2, u1 at SE12(4032)=un0v_j3,
...
-- ============================================================================
-- Full n=1 DIV spec (shift=0): base → base+1064
...
theorem evm_div_n1_shift0_full_spec (sp base : Word)
    (a0 a1 a2 a3 b0 b1 b2 b3 v5 v6 v7 v10 v11 : Word)
    (q0 q1 q2 q3 u0_old u1_old u2_old u3_old u4_old u5 u6 u7 : Word)
    (n_mem shift_mem j_old ret_mem d_mem dlo_mem scratch_un0 : Word)
    (hbnz : b0 ||| b1 ||| b2 ||| b3 ≠ 0)
  ...
  have hPLLB := evm_div_n1_shift0_preloop_loopbody_spec sp base
  ...
  -- q0=q0v, q1=q1v, q2=q2v, q3=q3v (ALL 4 meaningful)
  -- m0=b0, m8=b1, m16=b2, m24=b3 (the b memory values, unchanged)
  ...
  -- epilogue output: x5=q0v, x6=q1v, x7=q2v, x10=q3v (ALL 4 meaningful)
  -- shift=0 so (clzResult b0).1=0, stored at 3992
  exact ⟨q0v, q1v, q2v, q3v, _, x1v, x11v,
    u0v, u1v, u2v, u3v, u4v, u5v, u6v, u7v, j_v,
    retv, dv, dlov, sunv,
    by xperm_hyp hPL⟩
