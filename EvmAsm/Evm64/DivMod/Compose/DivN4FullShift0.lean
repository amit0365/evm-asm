/-
  EvmAsm.Evm64.DivMod.Compose.DivN4FullShift0
...
-- (Same as in DivN4Full.lean, re-declared as private)
-- ============================================================================
...
theorem evm_div_n4_shift0_preloop_loopbody_spec (sp base : Word)
  ...
  have hPL := evm_div_n4_shift0_to_loopSetup_spec sp base a0 a1 a2 a3 b0 b1 b2 b3 v5 v6 v7 v10
  ...
  -- For shift=0: shift = (clzResult b3).1 = 0, anti_shift = SE12(0) - 0 = 0
  -- u[] = a[] (copies), b' = b (no normalization)
...
theorem evm_div_n4_shift0_full_spec (sp base : Word)
    (a0 a1 a2 a3 b0 b1 b2 b3 v5 v6 v7 v10 v11 : Word)
    (q0 q1 q2 q3 u0_old u1_old u2_old u3_old u4_old u5 u6 u7 : Word)
    (n_mem shift_mem j_old ret_mem d_mem dlo_mem scratch_un0 : Word)
    (hbnz : b0 ||| b1 ||| b2 ||| b3 ≠ 0)
  ...
  have hPLLB := evm_div_n4_shift0_preloop_loopbody_spec sp base
  ...
  -- POST_LOOP_PRE for shift=0: registers + shift_mem + q[] + output memory (16 atoms)
  let POST_LOOP_PRE :=
  ...
  exact ⟨qv, _, signExtend12 (4095 : BitVec 12), x11v,
    un0v, un1v, un2v, un3v, u4v, retv, dv, dlov, sunv,
    by xperm_hyp hPL⟩
