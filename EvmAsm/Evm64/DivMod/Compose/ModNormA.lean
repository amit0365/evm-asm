...
theorem mod_normA_full_spec (sp a0 a1 a2 a3 v5 v7 v10 shift anti_shift : Word)
  ...
  have htop := divK_normA_top_spec 24 4024 sp a3 v5 v7 anti_shift u4Old (base + normAOff)
  ...
  have hma1 := divK_normA_mergeA_spec 16 4032 sp a3 a2 u4 v10 shift anti_shift u3Old (base + 324)
  ...
  have hmb := divK_normA_mergeB_spec 8 4040 sp a2 a1 u3 (a2 >>> (anti_shift.toNat % 64))
    shift anti_shift u2Old (base + 344)
  ...
  have hma2 := divK_normA_mergeA_spec 0 4048 sp a1 a0 u2 (a1 >>> (anti_shift.toNat % 64))
    shift anti_shift u1Old (base + 364)
