/-
  EvmAsm.Evm64.DivMod.Compose.ModN4Full
...
theorem evm_mod_n4_preloop_loopbody_spec (sp base : Word)
  ...
  have hPL := evm_mod_n4_to_loopSetup_spec sp base a0 a1 a2 a3 b0 b1 b2 b3 v5 v6 v7 v10
...
theorem evm_mod_n4_full_spec (sp base : Word)
    (a0 a1 a2 a3 b0 b1 b2 b3 v5 v6 v7 v10 v11 : Word)
    (q0 q1 q2 q3 u0_old u1_old u2_old u3_old u4_old u5 u6 u7 : Word)
    (n_mem shift_mem j_old ret_mem d_mem dlo_mem scratch_un0 : Word)
    (hbnz : b0 ||| b1 ||| b2 ||| b3 ≠ 0)
  ...
  have hPLLB := evm_mod_n4_preloop_loopbody_spec sp base
  ...
  -- POST_LOOP_PRE = hDE's precondition (15 atoms: registers + shift_mem + u[] + output)
  let POST_LOOP_PRE :=
    ...
    ((sp + 32) ↦ₘ b0') ** ((sp + 40) ↦ₘ b1') **
    ((sp + 48) ↦ₘ b2') ** ((sp + 56) ↦ₘ b3')
  -- LEFTOVER includes q[], u4, x1, x11, a[], zeroed u5-u7, n, j, scratch
