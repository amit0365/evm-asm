...
private theorem divK_phaseC2_code_sub_modCode (base : Word) :
    ∀ a i, (divK_phaseC2_code 172 (base + 212)) a = some i → (modCode base) a = some i := by
...
private theorem mod_signExtend13_172 : signExtend13 (172 : BitVec 13) = (172 : Word) := by native_decide
...
private theorem divK_normB_code_sub_modCode (base : Word) :
    ∀ a i, (CodeReq.ofProg (base + 228) divK_normB) a = some i → (modCode base) a = some i := by
...
private theorem mod_se12_56 : signExtend12 (56 : BitVec 12) = (56 : Word) := by native_decide
private theorem mod_se12_48 : signExtend12 (48 : BitVec 12) = (48 : Word) := by native_decide
private theorem mod_se12_40 : signExtend12 (40 : BitVec 12) = (40 : Word) := by native_decide
private theorem mod_se12_32 : signExtend12 (32 : BitVec 12) = (32 : Word) := by native_decide
...
theorem mod_normB_full_spec (sp b0 b1 b2 b3 v5 v7 shift anti_shift : Word) (base : Word)
    ...
    let b1' := (b1 <<< (shift.toNat % 64)) ||| (b0 >>> (anti_shift.toNat % 64))
    let b0' := b0 <<< (shift.toNat % 64)
    cpsTriple (base + 228) (base + 312) (modCode base)
      ((.x12 ↦ᵣ sp) ** (.x5 ↦ᵣ v5) ** (.x7 ↦ᵣ v7) **
       (.x6 ↦ᵣ shift) ** (.x2 ↦ᵣ anti_shift) **
       ((sp + 32) ↦ₘ b0) ** ((sp + 40) ↦ₘ b1) **
       ((sp + 48) ↦ₘ b2) ** ((sp + 56) ↦ₘ b3))
