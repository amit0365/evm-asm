...
-- ============================================================================
-- Double-addback (_da) two-iteration (j=1, j=0) unified composition
-- Same pattern as divK_loop_n1_iter10_unified_spec but with _da per-iteration specs
-- ============================================================================

set_option maxRecDepth 4096 in
set_option maxHeartbeats 12800000 in
/-- Unified n=1 two-iteration _da loop composition for j=1 and j=0,
    parameterized by `(bltu_1 bltu_0 : Bool)`.
    Covers all 4 path combinations (max×max, call×call, max×call, call×max).
    Dispatches to existing _da per-iteration specs in LoopComposeN1.lean. -/
theorem divK_loop_n1_iter10_unified_da_spec (bltu_1 bltu_0 : Bool)
    (sp j_old v5_old v6_old v7_old v10_old v11_old v2_old
     v0 v1 v2 v3 u0 u1 u2 u3 u_top u0_orig q1_old q0_old : Word)
    (ret_mem d_mem dlo_mem scratch_un0 : Word)
    (base : Word)
    ...
    (hv_u0_0 : isValidDwordAccess ((sp + signExtend12 4056 - (0 : Word) <<< (3 : BitVec 6).toNat) + signExtend12 0) = true)
    (hv_q0 : isValidDwordAccess (sp + signExtend12 4088 - (0 : Word) <<< (3 : BitVec 6).toNat) = true)
    -- Unified branch conditions (using iterN1_da for j=0)
    (hbltu_1 : bltu_1 = BitVec.ult u1 v0)
    (hbltu_0 : bltu_0 = BitVec.ult (iterN1_da bltu_1 v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.1 v0) :
    cpsTriple (base + loopBodyOff) (base + denormOff) (sharedDivModCode base)
      (loopN1Iter10PreWithScratch sp j_old v5_old v6_old v7_old v10_old v11_old v2_old
        v0 v1 v2 v3 u0 u1 u2 u3 u_top u0_orig q1_old q0_old
        ret_mem d_mem dlo_mem scratch_un0)
      (loopN1Iter10Post_da bltu_1 bltu_0 sp base v0 v1 v2 v3 u0 u1 u2 u3 u_top u0_orig
        ret_mem d_mem dlo_mem scratch_un0) := by
  -- Dispatch to per-iteration _da specs via case analysis on (bltu_1, bltu_0)
  cases bltu_1 <;> cases bltu_0 <;> simp only [iterN1_da_true, iterN1_da_false] at hbltu_0
  · -- (false, false) = max*max
    have hbltu_1' : ¬BitVec.ult u1 v0 := by
      rw [show BitVec.ult u1 v0 = false from hbltu_1.symm]; decide
    have hbltu_0' : ¬BitVec.ult (iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.1 v0 := by
      rw [show BitVec.ult _ v0 = false from hbltu_0.symm]; decide
    delta loopN1Iter10PreWithScratch loopN1Iter10Pre; simp only []
    let u_base_1 := sp + signExtend12 4056 - (1 : Word) <<< (3 : BitVec 6).toNat
    let u_base_0 := sp + signExtend12 4056 - (0 : Word) <<< (3 : BitVec 6).toNat
    ...
    let q_addr_0 := sp + signExtend12 4088 - (0 : Word) <<< (3 : BitVec 6).toNat
    -- j=1 max _da spec
    have J1 := divK_loop_body_n1_max_unified_j1_da_spec sp j_old v5_old v6_old v7_old v10_old v11_old v2_old
      v0 v1 v2 v3 u0 u1 u2 u3 u_top q1_old base
      hv_j hv_n1 hv_uhi_1 hv_ulo_1 hv_vtop hv_v0 hv_u0_1 hv_v1 hv_u1_1 hv_v2 hv_u2_1 hv_v3 hv_u3_1 hv_u4_1 hv_q1
      hbltu_1'
    ...
    have hv_u4_0 : isValidDwordAccess ((sp + signExtend12 4056 - (0 : Word) <<< (3 : BitVec 6).toNat) + signExtend12 4064) = true := by
      rw [← u_n1_j1_4072_eq_j0_4064]; exact hv_u3_1
    -- j=0 max _da spec (inputs from j=1 via iterN1Max_da)
    have J0 := divK_loop_body_n1_max_unified_j0_da_spec sp (1 : Word)
      ((1 : Word) <<< (3 : BitVec 6).toNat) u_base_1 q_addr_1
      ((mulsubN4 (signExtend12 4095 : Word) v0 v1 v2 v3 u0 u1 u2 u3).2.2.2.2)
      ((iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).1)
      ((iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.2.2.1)
      v0 v1 v2 v3
      u0_orig
      (iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.1
      (iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.1
      (iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.2.1
      (iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.2.2.1
      q0_old base
      hv_j hv_n1 hv_uhi_0 hv_ulo_0 hv_vtop hv_v0 hv_u0_0 hv_v1 hv_u1_0 hv_v2 hv_u2_0 hv_v3 hv_u3_0 hv_u4_0 hv_q0
      hbltu_0'
    ...
    -- Frame j=0 with j=1's carried atoms and scratch
    have J0f := cpsTriple_frame_left _ _ _ _ _
      (((u_base_1 + signExtend12 4064) ↦ₘ (iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.2.2.2) **
       (q_addr_1 ↦ₘ (iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).1) **
       (sp + signExtend12 3968 ↦ₘ ret_mem) ** (sp + signExtend12 3960 ↦ₘ d_mem) **
       (sp + signExtend12 3952 ↦ₘ dlo_mem) ** (sp + signExtend12 3944 ↦ₘ scratch_un0))
      (by pcFree) J0
    -- Compose j=1 and j=0 via address rewriting
    have full := cpsTriple_seq_with_perm_same_cr _ _ _ _ _ _ _ _
      (fun h hp => by
        delta loopIterPostN1Max_da loopExitPostN1 loopExitPost at hp
        simp only [] at hp ⊢
        have hj' : (1 : Word) + signExtend12 4095 = (0 : Word) := by decide
        rw [hj', u_n1_j1_0_eq_j0_4088 sp, u_n1_j1_4088_eq_j0_4080 sp,
            u_n1_j1_4080_eq_j0_4072 sp, u_n1_j1_4072_eq_j0_4064 sp] at hp
        ...
        xperm_hyp hp)
      J1f J0f
    -- Bridge to unified _da postcondition
    exact cpsTriple_consequence _ _ _ _ _ _ _
      (fun h hp => by xperm_hyp hp)
      (fun h hp => by
        delta loopN1Iter10Post_da loopIterPostN1_da
        simp only [iterN1_da_false, sepConj_emp_right']
        xperm_hyp hp)
      full
  · -- (false, true) = max*call
    have hbltu_1' : ¬BitVec.ult u1 v0 := by
      rw [show BitVec.ult u1 v0 = false from hbltu_1.symm]; decide
    have hbltu_0' : BitVec.ult (iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.1 v0 :=
      hbltu_0.symm ▸ rfl
    delta loopN1Iter10PreWithScratch loopN1Iter10Pre; simp only []
    let u_base_1 := sp + signExtend12 4056 - (1 : Word) <<< (3 : BitVec 6).toNat
    let u_base_0 := sp + signExtend12 4056 - (0 : Word) <<< (3 : BitVec 6).toNat
    ...
    have hv_u4_0 : isValidDwordAccess ((sp + signExtend12 4056 - (0 : Word) <<< (3 : BitVec 6).toNat) + signExtend12 4064) = true := by
      rw [← u_n1_j1_4072_eq_j0_4064]; exact hv_u3_1
    -- j=0 call _da spec (includes scratch in pre/post)
    have J0 := divK_loop_body_n1_call_unified_j0_da_spec sp (1 : Word)
      ((1 : Word) <<< (3 : BitVec 6).toNat) u_base_1 q_addr_1
      ((mulsubN4 (signExtend12 4095 : Word) v0 v1 v2 v3 u0 u1 u2 u3).2.2.2.2)
      ((iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).1)
      ((iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.2.2.1)
  ...
  · -- (true, false) = call*max
    have hbltu_1' : BitVec.ult u1 v0 := hbltu_1.symm ▸ rfl
    have hbltu_0' : ¬BitVec.ult (iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.1 v0 := by
      rw [show BitVec.ult _ v0 = false from hbltu_0.symm]; decide
    delta loopN1Iter10PreWithScratch loopN1Iter10Pre; simp only []
    let u_base_1 := sp + signExtend12 4056 - (1 : Word) <<< (3 : BitVec 6).toNat
    let u_base_0 := sp + signExtend12 4056 - (0 : Word) <<< (3 : BitVec 6).toNat
    let q_addr_1 := sp + signExtend12 4088 - (1 : Word) <<< (3 : BitVec 6).toNat
    let q_addr_0 := sp + signExtend12 4088 - (0 : Word) <<< (3 : BitVec 6).toNat
    -- j=1 call _da spec (includes scratch)
    have J1 := divK_loop_body_n1_call_unified_j1_da_spec sp j_old v5_old v6_old v7_old v10_old v11_old v2_old
      v0 v1 v2 v3 u0 u1 u2 u3 u_top q1_old ret_mem d_mem dlo_mem scratch_un0 base
      hv_j hv_n1 hv_uhi_1 hv_ulo_1 hv_vtop hv_ret hv_d hv_dlo hv_scratch_un0 halign
      hv_v0 hv_u0_1 hv_v1 hv_u1_1 hv_v2 hv_u2_1 hv_v3 hv_u3_1 hv_u4_1 hv_q1
      hbltu_1'
    ...
    have hv_u4_0 : isValidDwordAccess ((sp + signExtend12 4056 - (0 : Word) <<< (3 : BitVec 6).toNat) + signExtend12 4064) = true := by
      rw [← u_n1_j1_4072_eq_j0_4064]; exact hv_u3_1
    -- j=0 max _da spec (no scratch)
    have J0 := divK_loop_body_n1_max_unified_j0_da_spec sp (1 : Word)
      ((1 : Word) <<< (3 : BitVec 6).toNat) u_base_1 q_addr_1
      ((mulsubN4 (div128Quot u1 u0 v0) v0 v1 v2 v3 u0 u1 u2 u3).2.2.2.2)
      ((iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).1)
      ((iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.2.2.1)
      v0 v1 v2 v3
      u0_orig
      (iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.1
      (iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.1
      (iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.2.1
      (iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.2.2.1
      q0_old base
      hv_j hv_n1 hv_uhi_0 hv_ulo_0 hv_vtop hv_v0 hv_u0_0 hv_v1 hv_u1_0 hv_v2 hv_u2_0 hv_v3 hv_u3_0 hv_u4_0 hv_q0
      hbltu_0'
    ...
    -- Frame j=0 with j=1's carried atoms + j=1 scratch (persists from call)
    have J0f := cpsTriple_frame_left _ _ _ _ _
      (((u_base_1 + signExtend12 4064) ↦ₘ (iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.2.2.2) **
       (q_addr_1 ↦ₘ (iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).1) **
       (sp + signExtend12 3968 ↦ₘ (base + 516)) **
       (sp + signExtend12 3960 ↦ₘ v0) **
       (sp + signExtend12 3952 ↦ₘ div128DLo v0) **
       (sp + signExtend12 3944 ↦ₘ div128Un0 u0))
    ...
    have full := cpsTriple_seq_with_perm_same_cr _ _ _ _ _ _ _ _
      (fun h hp => by
        delta loopIterPostN1Call_da loopExitPostN1 loopExitPost at hp
        simp only [] at hp ⊢
        have hj' : (1 : Word) + signExtend12 4095 = (0 : Word) := by decide
        rw [hj', u_n1_j1_0_eq_j0_4088 sp, u_n1_j1_4088_eq_j0_4080 sp,
            u_n1_j1_4080_eq_j0_4072 sp, u_n1_j1_4072_eq_j0_4064 sp] at hp
    ...
    exact cpsTriple_consequence _ _ _ _ _ _ _
      ...
      (fun h hp => by
        delta loopN1Iter10Post_da loopIterPostN1_da
        simp only [iterN1_da_true, sepConj_emp_right']
        xperm_hyp hp)
      full
  · -- (true, true) = call*call
    have hbltu_1' : BitVec.ult u1 v0 := hbltu_1.symm ▸ rfl
    have hbltu_0' : BitVec.ult (iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.1 v0 :=
      hbltu_0.symm ▸ rfl
    delta loopN1Iter10PreWithScratch loopN1Iter10Pre; simp only []
    let u_base_1 := sp + signExtend12 4056 - (1 : Word) <<< (3 : BitVec 6).toNat
    let u_base_0 := sp + signExtend12 4056 - (0 : Word) <<< (3 : BitVec 6).toNat
    ...
    have hv_u4_0 : isValidDwordAccess ((sp + signExtend12 4056 - (0 : Word) <<< (3 : BitVec 6).toNat) + signExtend12 4064) = true := by
      rw [← u_n1_j1_4072_eq_j0_4064]; exact hv_u3_1
    -- j=0 call _da spec (includes scratch -- j=0 overwrites j=1's scratch)
    have J0 := divK_loop_body_n1_call_unified_j0_da_spec sp (1 : Word)
      ((1 : Word) <<< (3 : BitVec 6).toNat) u_base_1 q_addr_1
      ((mulsubN4 (div128Quot u1 u0 v0) v0 v1 v2 v3 u0 u1 u2 u3).2.2.2.2)
      ((iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).1)
...
-- ============================================================================
-- Three-iteration _da: compose j=2 with iter10_da -- separate lemmas per case
-- Postcondition uses @[irreducible] loopN1Iter210Post_da
-- ============================================================================

set_option maxRecDepth 4096 in
set_option maxHeartbeats 12800000 in
/-- Three-iteration _da composition when j=2 is max (bltu_2 = false).
    Composes j=2 _da max spec with the 2-iteration iter10 unified _da spec. -/
theorem divK_loop_n1_max_iter10_da_spec (bltu_1 bltu_0 : Bool)
    (sp j_old v5_old v6_old v7_old v10_old v11_old v2_old
     v0 v1 v2 v3 u0 u1 u2 u3 u_top
     u0_orig_1 u0_orig_0
     q2_old q1_old q0_old : Word)
    ...
    (hv_q0 : isValidDwordAccess (sp + signExtend12 4088 - (0 : Word) <<< (3 : BitVec 6).toNat) = true)
    (hbltu_2 : ¬BitVec.ult u1 v0)
    (hbltu_1 : bltu_1 = BitVec.ult (iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.1 v0)
    (hbltu_0 : bltu_0 = BitVec.ult (iterN1_da bltu_1 v0 v1 v2 v3 u0_orig_1
      (iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.1
      (iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.1
      (iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.2.1
      (iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.2.2.1).2.1 v0) :
    cpsTriple (base + loopBodyOff) (base + denormOff) (sharedDivModCode base)
      (loopN1Iter210PreWithScratch sp j_old v5_old v6_old v7_old v10_old v11_old v2_old
        v0 v1 v2 v3 u0 u1 u2 u3 u_top
        u0_orig_1 u0_orig_0 q2_old q1_old q0_old
        ret_mem d_mem dlo_mem scratch_un0)
      (loopN1Iter210Post_da false bltu_1 bltu_0 sp base v0 v1 v2 v3 u0 u1 u2 u3 u_top
        u0_orig_1 u0_orig_0 ret_mem d_mem dlo_mem scratch_un0) := by
  let r2 := iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top
  let u_base_2 := sp + signExtend12 4056 - (2 : Word) <<< (3 : BitVec 6).toNat
  let u_base_1 := sp + signExtend12 4056 - (1 : Word) <<< (3 : BitVec 6).toNat
  let q_addr_2 := sp + signExtend12 4088 - (2 : Word) <<< (3 : BitVec 6).toNat
  let q_addr_1 := sp + signExtend12 4088 - (1 : Word) <<< (3 : BitVec 6).toNat
  ...
  have hv_u4_1 : isValidDwordAccess ((sp + signExtend12 4056 - (1 : Word) <<< (3 : BitVec 6).toNat) + signExtend12 4064) = true := by
    rw [← u_n1_j2_4072_eq_j1_4064]; exact hv_u3_2
  -- j=2 max _da spec
  have J2 := divK_loop_body_n1_max_unified_j2_da_spec sp j_old v5_old v6_old v7_old v10_old v11_old v2_old
    v0 v1 v2 v3 u0 u1 u2 u3 u_top q2_old base
    hv_j hv_n1 hv_uhi_2 hv_ulo_2 hv_vtop hv_v0 hv_u0_2 hv_v1 hv_u1_2 hv_v2 hv_u2_2 hv_v3 hv_u3_2 hv_u4_2 hv_q2
    hbltu_2
    (by sorry : isAddbackCarry2NzN1Max v0 v1 v2 v3 u0 u1 u2 u3 u_top)
  ...
  have J2f := cpsTriple_frame_left _ _ _ _ _
    (((u_base_1 + signExtend12 0) ↦ₘ u0_orig_1) ** (q_addr_1 ↦ₘ q1_old) **
     ...
     (sp + signExtend12 3952 ↦ₘ dlo_mem) ** (sp + signExtend12 3944 ↦ₘ scratch_un0))
    (by pcFree) J2
  -- iter10 _da unified spec (inputs from j=2 max _da output)
  have H10 := divK_loop_n1_iter10_unified_da_spec bltu_1 bltu_0
    sp (2 : Word) ((2 : Word) <<< (3 : BitVec 6).toNat) u_base_2 q_addr_2
    ((mulsubN4 (signExtend12 4095 : Word) v0 v1 v2 v3 u0 u1 u2 u3).2.2.2.2)
    r2.1 r2.2.2.2.2.1
    v0 v1 v2 v3
  ...
  exact cpsTriple_consequence _ _ _ _ _ _ _
    (fun h hp => by delta loopN1Iter210PreWithScratch loopN1Iter210Pre at hp; xperm_hyp hp)
    (fun h hp => by
      delta loopN1Iter210Post_da loopN1Iter10Post_da at hp ⊢
      simp only [iterN1_da_false, Bool.false_eq_true, ↓reduceIte] at hp ⊢
      cases bltu_1 <;> cases bltu_0 <;> xperm_hyp hp)
    full

set_option maxRecDepth 4096 in
set_option maxHeartbeats 12800000 in
/-- Three-iteration _da composition when j=2 is call (bltu_2 = true).
    Composes j=2 _da call spec with the 2-iteration iter10 unified _da spec. -/
theorem divK_loop_n1_call_iter10_da_spec (bltu_1 bltu_0 : Bool)
    (sp j_old v5_old v6_old v7_old v10_old v11_old v2_old
     v0 v1 v2 v3 u0 u1 u2 u3 u_top
     u0_orig_1 u0_orig_0
     q2_old q1_old q0_old : Word)
    ...
    (hv_q0 : isValidDwordAccess (sp + signExtend12 4088 - (0 : Word) <<< (3 : BitVec 6).toNat) = true)
    (hbltu_2 : BitVec.ult u1 v0)
    (hbltu_1 : bltu_1 = BitVec.ult (iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.1 v0)
    (hbltu_0 : bltu_0 = BitVec.ult (iterN1_da bltu_1 v0 v1 v2 v3 u0_orig_1
      (iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.1
      (iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.1
      (iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.2.1
      (iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.2.2.1).2.1 v0) :
    cpsTriple (base + loopBodyOff) (base + denormOff) (sharedDivModCode base)
      (loopN1Iter210PreWithScratch sp j_old v5_old v6_old v7_old v10_old v11_old v2_old
        v0 v1 v2 v3 u0 u1 u2 u3 u_top
        u0_orig_1 u0_orig_0 q2_old q1_old q0_old
        ret_mem d_mem dlo_mem scratch_un0)
      (loopN1Iter210Post_da true bltu_1 bltu_0 sp base v0 v1 v2 v3 u0 u1 u2 u3 u_top
        u0_orig_1 u0_orig_0 ret_mem d_mem dlo_mem scratch_un0) := by
  let r2 := iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top
  let u_base_2 := sp + signExtend12 4056 - (2 : Word) <<< (3 : BitVec 6).toNat
  let u_base_1 := sp + signExtend12 4056 - (1 : Word) <<< (3 : BitVec 6).toNat
  let q_addr_2 := sp + signExtend12 4088 - (2 : Word) <<< (3 : BitVec 6).toNat
  let q_addr_1 := sp + signExtend12 4088 - (1 : Word) <<< (3 : BitVec 6).toNat
  ...
  have hv_u4_1 : isValidDwordAccess ((sp + signExtend12 4056 - (1 : Word) <<< (3 : BitVec 6).toNat) + signExtend12 4064) = true := by
    rw [← u_n1_j2_4072_eq_j1_4064]; exact hv_u3_2
  -- j=2 call _da spec (includes scratch)
  have J2 := divK_loop_body_n1_call_unified_j2_da_spec sp j_old v5_old v6_old v7_old v10_old v11_old v2_old
    v0 v1 v2 v3 u0 u1 u2 u3 u_top q2_old ret_mem d_mem dlo_mem scratch_un0 base
    hv_j hv_n1 hv_uhi_2 hv_ulo_2 hv_vtop hv_ret hv_d hv_dlo hv_scratch_un0 halign
    hv_v0 hv_u0_2 hv_v1 hv_u1_2 hv_v2 hv_u2_2 hv_v3 hv_u3_2 hv_u4_2 hv_q2
    hbltu_2
  ...
  have J2f := cpsTriple_frame_left _ _ _ _ _
    (((u_base_1 + signExtend12 0) ↦ₘ u0_orig_1) ** (q_addr_1 ↦ₘ q1_old) **
     ((u_base_0 + signExtend12 0) ↦ₘ u0_orig_0) ** (q_addr_0 ↦ₘ q0_old))
    (by pcFree) J2
  -- iter10 _da unified spec (inputs from j=2 call _da output, scratch = j=2 call values)
  have H10 := divK_loop_n1_iter10_unified_da_spec bltu_1 bltu_0
    sp (2 : Word) ((2 : Word) <<< (3 : BitVec 6).toNat) u_base_2 q_addr_2
    ((mulsubN4 (div128Quot u1 u0 v0) v0 v1 v2 v3 u0 u1 u2 u3).2.2.2.2)
    r2.1 r2.2.2.2.2.1
  ...
  exact cpsTriple_consequence _ _ _ _ _ _ _
    ...
    (fun h hp => by
      delta loopN1Iter210Post_da loopN1Iter10Post_da at hp ⊢
      simp only [iterN1_da_true, ite_true] at hp ⊢
      cases bltu_1 <;> cases bltu_0 <;> xperm_hyp hp)
    full

-- ============================================================================
-- Three-iteration _da unified dispatch: cases bltu_2
-- ============================================================================

set_option maxRecDepth 4096 in
set_option maxHeartbeats 12800000 in
/-- Unified n=1 three-iteration _da loop composition, parameterized by
    `(bltu_2 bltu_1 bltu_0 : Bool)`.  Covers all 8 path combinations.
    Dispatches to divK_loop_n1_max_iter10_da_spec / divK_loop_n1_call_iter10_da_spec. -/
theorem divK_loop_n1_iter210_unified_da_spec (bltu_2 bltu_1 bltu_0 : Bool)
    (sp j_old v5_old v6_old v7_old v10_old v11_old v2_old
     v0 v1 v2 v3 u0 u1 u2 u3 u_top
     u0_orig_1 u0_orig_0
     q2_old q1_old q0_old : Word)
    ...
    (hv_q0 : isValidDwordAccess (sp + signExtend12 4088 - (0 : Word) <<< (3 : BitVec 6).toNat) = true)
    (hbltu_2 : bltu_2 = BitVec.ult u1 v0)
    (hbltu_1 : bltu_1 = BitVec.ult (iterN1_da bltu_2 v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.1 v0)
    (hbltu_0 : bltu_0 = BitVec.ult (iterN1_da bltu_1 v0 v1 v2 v3 u0_orig_1
      (iterN1_da bltu_2 v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.1
      (iterN1_da bltu_2 v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.1
      (iterN1_da bltu_2 v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.2.1
      (iterN1_da bltu_2 v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.2.2.1).2.1 v0) :
    cpsTriple (base + loopBodyOff) (base + denormOff) (sharedDivModCode base)
      (loopN1Iter210PreWithScratch sp j_old v5_old v6_old v7_old v10_old v11_old v2_old
        v0 v1 v2 v3 u0 u1 u2 u3 u_top
        u0_orig_1 u0_orig_0 q2_old q1_old q0_old
        ret_mem d_mem dlo_mem scratch_un0)
      (loopN1Iter210Post_da bltu_2 bltu_1 bltu_0 sp base v0 v1 v2 v3 u0 u1 u2 u3 u_top
        u0_orig_1 u0_orig_0 ret_mem d_mem dlo_mem scratch_un0) := by
  cases bltu_2 <;> simp only [iterN1_da_true, iterN1_da_false] at hbltu_1 hbltu_0
  · -- bltu_2 = false -> max
    have hbltu_2' : ¬BitVec.ult u1 v0 := by
      rw [show BitVec.ult u1 v0 = false from hbltu_2.symm]; decide
    exact divK_loop_n1_max_iter10_da_spec bltu_1 bltu_0
      sp j_old v5_old v6_old v7_old v10_old v11_old v2_old
      v0 v1 v2 v3 u0 u1 u2 u3 u_top u0_orig_1 u0_orig_0 q2_old q1_old q0_old
      ret_mem d_mem dlo_mem scratch_un0 base
      hv_j hv_n1 hv_uhi_2 hv_ulo_2 hv_vtop hv_ret hv_d hv_dlo hv_scratch_un0 halign
  ...
  · -- bltu_2 = true -> call
    have hbltu_2' : BitVec.ult u1 v0 := hbltu_2.symm ▸ rfl
    exact divK_loop_n1_call_iter10_da_spec bltu_1 bltu_0
      sp j_old v5_old v6_old v7_old v10_old v11_old v2_old
      v0 v1 v2 v3 u0 u1 u2 u3 u_top u0_orig_1 u0_orig_0 q2_old q1_old q0_old
      ret_mem d_mem dlo_mem scratch_un0 base
      hv_j hv_n1 hv_uhi_2 hv_ulo_2 hv_vtop hv_ret hv_d hv_dlo hv_scratch_un0 halign
...
-- ============================================================================
-- Full four-iteration _da: compose j=3 with iter210_da -- separate lemmas per case
-- Postcondition uses @[irreducible] loopN1UnifiedPost_da
-- ============================================================================

set_option maxRecDepth 4096 in
set_option maxHeartbeats 12800000 in
/-- Four-iteration _da composition when j=3 is max (bltu_3 = false).
    Composes j=3 _da max spec with the 3-iteration iter210 unified _da spec. -/
theorem divK_loop_n1_max_iter210_da_spec (bltu_2 bltu_1 bltu_0 : Bool)
    (sp j_old v5_old v6_old v7_old v10_old v11_old v2_old
     v0 v1 v2 v3 u0 u1 u2 u3 u_top
     u0_orig_2 u0_orig_1 u0_orig_0
     q3_old q2_old q1_old q0_old : Word)
    ...
    (hv_q0 : isValidDwordAccess (sp + signExtend12 4088 - (0 : Word) <<< (3 : BitVec 6).toNat) = true)
    (hbltu_3 : ¬BitVec.ult u1 v0)
    (hbltu_2 : bltu_2 = BitVec.ult (iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.1 v0)
    ...
    (hbltu_0 : bltu_0 = BitVec.ult (iterN1_da bltu_1 v0 v1 v2 v3 u0_orig_1
      (iterN1_da bltu_2 v0 v1 v2 v3 u0_orig_2
        ...
        (iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.1
        (iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.2.1
        (iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.2.2.1).2.1
      (iterN1_da bltu_2 v0 v1 v2 v3 u0_orig_2
        (iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.1
        (iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.1
        (iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.2.1
        (iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.2.2.1).2.2.1
      (iterN1_da bltu_2 v0 v1 v2 v3 u0_orig_2
        (iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.1
        (iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.1
        (iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.2.1
        (iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.2.2.1).2.2.2.1
      (iterN1_da bltu_2 v0 v1 v2 v3 u0_orig_2
        (iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.1
        (iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.1
        (iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.2.1
        (iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.2.2.1).2.2.2.2.1).2.1 v0) :
    cpsTriple (base + loopBodyOff) (base + denormOff) (sharedDivModCode base)
      (loopN1PreWithScratch sp j_old v5_old v6_old v7_old v10_old v11_old v2_old
        v0 v1 v2 v3 u0 u1 u2 u3 u_top
        u0_orig_2 u0_orig_1 u0_orig_0 q3_old q2_old q1_old q0_old
        ret_mem d_mem dlo_mem scratch_un0)
      (loopN1UnifiedPost_da false bltu_2 bltu_1 bltu_0 sp base v0 v1 v2 v3 u0 u1 u2 u3 u_top
        u0_orig_2 u0_orig_1 u0_orig_0 ret_mem d_mem dlo_mem scratch_un0) := by
  let r3 := iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top
  let u_base_3 := sp + signExtend12 4056 - (3 : Word) <<< (3 : BitVec 6).toNat
  let u_base_2 := sp + signExtend12 4056 - (2 : Word) <<< (3 : BitVec 6).toNat
  let q_addr_3 := sp + signExtend12 4088 - (3 : Word) <<< (3 : BitVec 6).toNat
  let q_addr_2 := sp + signExtend12 4088 - (2 : Word) <<< (3 : BitVec 6).toNat
  ...
  have hv_u4_2 : isValidDwordAccess ((sp + signExtend12 4056 - (2 : Word) <<< (3 : BitVec 6).toNat) + signExtend12 4064) = true := by
    rw [← u_n1_j3_4072_eq_j2_4064]; exact hv_u3_3
  -- j=3 max _da spec
  have J3 := divK_loop_body_n1_max_unified_j3_da_spec sp j_old v5_old v6_old v7_old v10_old v11_old v2_old
    v0 v1 v2 v3 u0 u1 u2 u3 u_top q3_old base
    hv_j hv_n1 hv_uhi_3 hv_ulo_3 hv_vtop hv_v0 hv_u0_3 hv_v1 hv_u1_3 hv_v2 hv_u2_3 hv_v3 hv_u3_3 hv_u4_3 hv_q3
    hbltu_3
    (by sorry : isAddbackCarry2NzN1Max v0 v1 v2 v3 u0 u1 u2 u3 u_top)
  ...
  have J3f := cpsTriple_frame_left _ _ _ _ _
    (((u_base_2 + signExtend12 0) ↦ₘ u0_orig_2) ** (q_addr_2 ↦ₘ q2_old) **
     ...
     (sp + signExtend12 3952 ↦ₘ dlo_mem) ** (sp + signExtend12 3944 ↦ₘ scratch_un0))
    (by pcFree) J3
  -- iter210 _da unified spec (inputs from j=3 max _da output)
  have H210 := divK_loop_n1_iter210_unified_da_spec bltu_2 bltu_1 bltu_0
    sp (3 : Word) ((3 : Word) <<< (3 : BitVec 6).toNat) u_base_3 q_addr_3
    ((mulsubN4 (signExtend12 4095 : Word) v0 v1 v2 v3 u0 u1 u2 u3).2.2.2.2)
    r3.1 r3.2.2.2.2.1
    v0 v1 v2 v3
  ...
  exact cpsTriple_consequence _ _ _ _ _ _ _
    (fun h hp => by delta loopN1PreWithScratch loopN1Pre at hp; xperm_hyp hp)
    (fun h hp => by
      delta loopN1UnifiedPost_da loopN1Iter210Post_da loopN1Iter10Post_da loopIterPostN1_da at hp ⊢
      simp only [iterN1_da_false, Bool.false_eq_true, ↓reduceIte, sepConj_emp_right'] at hp ⊢
      have hr3 : r3 = iterN1Max_da v0 v1 v2 v3 u0 u1 u2 u3 u_top := rfl
      have hub3 : u_base_3 = sp + signExtend12 4056 - (3 : Word) <<< (3 : BitVec 6).toNat := rfl
      have hqa3 : q_addr_3 = sp + signExtend12 4088 - (3 : Word) <<< (3 : BitVec 6).toNat := rfl
      simp only [hr3, hub3, hqa3] at hp
      rw [sepConj_assoc'] at hp
...
set_option maxRecDepth 4096 in
set_option maxHeartbeats 12800000 in
/-- Four-iteration _da composition when j=3 is call (bltu_3 = true).
    Composes j=3 _da call spec with the 3-iteration iter210 unified _da spec. -/
theorem divK_loop_n1_call_iter210_da_spec (bltu_2 bltu_1 bltu_0 : Bool)
    (sp j_old v5_old v6_old v7_old v10_old v11_old v2_old
     v0 v1 v2 v3 u0 u1 u2 u3 u_top
     u0_orig_2 u0_orig_1 u0_orig_0
     q3_old q2_old q1_old q0_old : Word)
    ...
    (hv_q0 : isValidDwordAccess (sp + signExtend12 4088 - (0 : Word) <<< (3 : BitVec 6).toNat) = true)
    (hbltu_3 : BitVec.ult u1 v0)
    (hbltu_2 : bltu_2 = BitVec.ult (iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.1 v0)
    (hbltu_1 : bltu_1 = BitVec.ult (iterN1_da bltu_2 v0 v1 v2 v3 u0_orig_2
      (iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.1
      (iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.1
      (iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.2.1
    ...
    (hbltu_0 : bltu_0 = BitVec.ult (iterN1_da bltu_1 v0 v1 v2 v3 u0_orig_1
      (iterN1_da bltu_2 v0 v1 v2 v3 u0_orig_2
        ...
        (iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.1
        (iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.2.1
        (iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.2.2.1).2.1
      (iterN1_da bltu_2 v0 v1 v2 v3 u0_orig_2
        (iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.1
        (iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.1
        (iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.2.1
        (iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.2.2.1).2.2.1
      (iterN1_da bltu_2 v0 v1 v2 v3 u0_orig_2
        (iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.1
        (iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.1
        (iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.2.1
        (iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.2.2.1).2.2.2.1
      (iterN1_da bltu_2 v0 v1 v2 v3 u0_orig_2
        (iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.1
        (iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.1
        (iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.2.1
        (iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top).2.2.2.2.1).2.2.2.2.1).2.1 v0) :
    cpsTriple (base + loopBodyOff) (base + denormOff) (sharedDivModCode base)
      (loopN1PreWithScratch sp j_old v5_old v6_old v7_old v10_old v11_old v2_old
        v0 v1 v2 v3 u0 u1 u2 u3 u_top
        u0_orig_2 u0_orig_1 u0_orig_0 q3_old q2_old q1_old q0_old
        ret_mem d_mem dlo_mem scratch_un0)
      (loopN1UnifiedPost_da true bltu_2 bltu_1 bltu_0 sp base v0 v1 v2 v3 u0 u1 u2 u3 u_top
        u0_orig_2 u0_orig_1 u0_orig_0 ret_mem d_mem dlo_mem scratch_un0) := by
  let r3 := iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top
  let u_base_3 := sp + signExtend12 4056 - (3 : Word) <<< (3 : BitVec 6).toNat
  let u_base_2 := sp + signExtend12 4056 - (2 : Word) <<< (3 : BitVec 6).toNat
  let q_addr_3 := sp + signExtend12 4088 - (3 : Word) <<< (3 : BitVec 6).toNat
  let q_addr_2 := sp + signExtend12 4088 - (2 : Word) <<< (3 : BitVec 6).toNat
  ...
  have hv_u4_2 : isValidDwordAccess ((sp + signExtend12 4056 - (2 : Word) <<< (3 : BitVec 6).toNat) + signExtend12 4064) = true := by
    rw [← u_n1_j3_4072_eq_j2_4064]; exact hv_u3_3
  -- j=3 call _da spec (includes scratch)
  have J3 := divK_loop_body_n1_call_unified_j3_da_spec sp j_old v5_old v6_old v7_old v10_old v11_old v2_old
    v0 v1 v2 v3 u0 u1 u2 u3 u_top q3_old ret_mem d_mem dlo_mem scratch_un0 base
    hv_j hv_n1 hv_uhi_3 hv_ulo_3 hv_vtop hv_ret hv_d hv_dlo hv_scratch_un0 halign
    hv_v0 hv_u0_3 hv_v1 hv_u1_3 hv_v2 hv_u2_3 hv_v3 hv_u3_3 hv_u4_3 hv_q3
    hbltu_3
  ...
  have J3f := cpsTriple_frame_left _ _ _ _ _
    (((u_base_2 + signExtend12 0) ↦ₘ u0_orig_2) ** (q_addr_2 ↦ₘ q2_old) **
     ...
     ((u_base_0 + signExtend12 0) ↦ₘ u0_orig_0) ** (q_addr_0 ↦ₘ q0_old))
    (by pcFree) J3
  -- iter210 _da unified spec (inputs from j=3 call _da output, scratch = j=3 call values)
  have H210 := divK_loop_n1_iter210_unified_da_spec bltu_2 bltu_1 bltu_0
    sp (3 : Word) ((3 : Word) <<< (3 : BitVec 6).toNat) u_base_3 q_addr_3
    ((mulsubN4 (div128Quot u1 u0 v0) v0 v1 v2 v3 u0 u1 u2 u3).2.2.2.2)
    r3.1 r3.2.2.2.2.1
  ...
  exact cpsTriple_consequence _ _ _ _ _ _ _
    ...
    (fun h hp => by
      delta loopN1UnifiedPost_da loopN1Iter210Post_da loopN1Iter10Post_da loopIterPostN1_da at hp ⊢
      simp only [iterN1_da_true, ite_true, sepConj_emp_right'] at hp ⊢
      have hr3 : r3 = iterN1Call_da v0 v1 v2 v3 u0 u1 u2 u3 u_top := rfl
      have hub3 : u_base_3 = sp + signExtend12 4056 - (3 : Word) <<< (3 : BitVec 6).toNat := rfl
      have hqa3 : q_addr_3 = sp + signExtend12 4088 - (3 : Word) <<< (3 : BitVec 6).toNat := rfl
      simp only [hr3, hub3, hqa3] at hp
      rw [sepConj_assoc'] at hp
...
-- ============================================================================
-- Final _da unified dispatch: cases bltu_3, delegates to max/call _da lemmas
-- ============================================================================

set_option maxRecDepth 4096 in
set_option maxHeartbeats 12800000 in
/-- Unified n=1 four-iteration _da loop composition, parameterized by
    `(bltu_3 bltu_2 bltu_1 bltu_0 : Bool)`.  Covers all 16 path combinations.
    Dispatches to divK_loop_n1_max_iter210_da_spec / divK_loop_n1_call_iter210_da_spec. -/
theorem divK_loop_n1_unified_da_spec (bltu_3 bltu_2 bltu_1 bltu_0 : Bool)
    (sp j_old v5_old v6_old v7_old v10_old v11_old v2_old
     v0 v1 v2 v3 u0 u1 u2 u3 u_top
     u0_orig_2 u0_orig_1 u0_orig_0
     q3_old q2_old q1_old q0_old : Word)
    ...
    cpsTriple (base + loopBodyOff) (base + denormOff) (sharedDivModCode base)
      ...
      (loopN1UnifiedPost_da bltu_3 bltu_2 bltu_1 bltu_0 sp base v0 v1 v2 v3 u0 u1 u2 u3 u_top
        u0_orig_2 u0_orig_1 u0_orig_0 ret_mem d_mem dlo_mem scratch_un0) := by
  cases bltu_3 <;> simp only [iterN1_da_true, iterN1_da_false] at hbltu_2 hbltu_1 hbltu_0
  · -- bltu_3 = false -> max
    have hbltu_3' : ¬BitVec.ult u1 v0 := by
      rw [show BitVec.ult u1 v0 = false from hbltu_3.symm]; decide
    exact divK_loop_n1_max_iter210_da_spec bltu_2 bltu_1 bltu_0
      sp j_old v5_old v6_old v7_old v10_old v11_old v2_old
      v0 v1 v2 v3 u0 u1 u2 u3 u_top u0_orig_2 u0_orig_1 u0_orig_0
      q3_old q2_old q1_old q0_old
      ret_mem d_mem dlo_mem scratch_un0 base
  ...
  · -- bltu_3 = true -> call
    have hbltu_3' : BitVec.ult u1 v0 := hbltu_3.symm ▸ rfl
    exact divK_loop_n1_call_iter210_da_spec bltu_2 bltu_1 bltu_0
      sp j_old v5_old v6_old v7_old v10_old v11_old v2_old
      v0 v1 v2 v3 u0 u1 u2 u3 u_top u0_orig_2 u0_orig_1 u0_orig_0
      q3_old q2_old q1_old q0_old
      ret_mem d_mem dlo_mem scratch_un0 base
